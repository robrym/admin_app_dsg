  ...
  function srcAppPagesContactsContactsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ContactsComponent = /*#__PURE__*/function () {
      function ContactsComponent(api, util, router) {
        ...
        this.dummy = Array(10);
        this.users = [];
        this.api.post_private('chats/getByGroup', param).then(function (data) {
          console.log(data);
          ...
          if (data && data.status === 200) {
            ...
            _this.api.post_private('stores/getChatsNames', uid).then(function (uids) {
              _this.dummy = [];
              console.log(uids);
            ...
            _this.api.post_private('users/getChatsNames', uid2).then(function (uids) {
              _this.dummy = [];
              console.log(uids);
            ...
            _this.api.post_private('drivers/getChatsNames', uid3).then(function (uids) {
              _this.dummy = [];
              console.log(uids);
      ...
      _createClass(ContactsComponent, [{
        ...
        value: function getMessages() {
          ...
          this.api.post_private('chats/getById', param).then(function (data) {
            console.log(data);
        ...
        value: function send() {
          ...
          if (this.message && this.id) {
            ...
            this.scrollToBottom();
            this.api.post_private('chats/save', param).then(function (data) {
              console.log(data);
