      ...
      _createClass(ManageLanguagesComponent, [{
        ...
        value: function preview_banner2(files) {
          ...
          if (this.jsonFile) {
            console.log('ok');
            this.spinner.show();
            this.api.uploadFile(this.jsonFile).subscribe(function (data) {
              console.log('==>>', data);

              _this4.spinner.hide();

              if (data && data.status === 200 && data.data) {
                _this4.jsonURL = data.data;
                _this4.jsonObject = src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].mediaURL + data.data;
              }
            }, function (err) {
              console.log(err);
        ...
        value: function create() {
          ...
          this.spinner.show();
          this.api.post_private('lang/save', param).then(function (data) {
            _this5.spinner.hide();
        ...
        value: function update() {
          ...
          console.log('ok', param);
          this.spinner.show();
          this.api.post_private('lang/editList', param).then(function (data) {
            _this6.spinner.hide();
