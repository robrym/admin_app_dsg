  ...
  function srcAppPagesAppWebAppWebComponentNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function View_AppWebComponent_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 3, "ngx-spinner", [["color", "#e74c3c"], ["type", "ball-pulse-sync"]], null, null, null, _node_modules_ngx_spinner_ngx_spinner_ngfactory__WEBPACK_IMPORTED_MODULE_3__["View_NgxSpinnerComponent_0"], _node_modules_ngx_spinner_ngx_spinner_ngfactory__WEBPACK_IMPORTED_MODULE_3__["RenderType_NgxSpinnerComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 770048, null, 0, ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerComponent"], [ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]], {
        ...
        update: "ngModelChange"
      }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](2048, null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControl"], null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgModel"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](31, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControlStatus"], [[4, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControl"]]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](32, 0, null, null, 9, "div", [["class", "form-group row"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](33, 0, null, null, 8, "div", [["class", "col-sm-12"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](34, 0, null, null, 1, "label", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Direcci\xF3n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](36, 0, null, null, 5, "input", [["class", "form-control"], ["placeholder", "Direcci\xF3n"], ["type", "text"]], [[2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "ngModelChange"], [null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
    ...
    var AppWebComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppWebComponent, [{
          ...
          this.api.get('general').then(function (data) {
            ...
            if (data && data.status === 200) {
              if (data && data.data && data.data.length) {
                ...
                _this.free = info.free;
                _this.min = info.min;
                _this.mobile = info.mobile;
                _this.shippingPrice = info.shippingPrice;
                _this.shipping = info.shipping;
                _this.state = info.state;
                _this.tax = info.tax;
                _this.zip = info.zip;
              }
            } else {
            ...
            console.log('havesave?', _this.haveSave);
          }, function (error) {
            console.log(error);
        ...
        value: function submit() {
          ...
          if (!this.mobile || this.mobile === '' || !this.email || this.email === '' || !this.address || this.address === '' || !this.city || this.city === '' || !this.state || this.state === '' || !this.zip || this.zip === '' || !this.country || this.country === '' || !this.min || this.min === '' || !this.free || this.free === '' || !this.tax || this.tax === '' || !this.shippingPrice || this.shippingPrice === '') {
            console.log('not ok');
          ...
          if (this.haveSave) {
            ...
            this.spinner.show();
            this.api.post_private('general/editList', param).then(function (data) {
              console.log('data', data);

              _this2.spinner.hide();

              if (data && data.status === 200) {
                _this2.success('Setting updated');
            ...
            this.spinner.show();
            this.api.post_private('general/save', _param).then(function (data) {
              console.log('data', data);
