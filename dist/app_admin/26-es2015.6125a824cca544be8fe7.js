...
/* harmony import */ var _setup_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./setup.component */ "./src/app/pages/setup/setup.component.ts");
...
class SetupComponent {
    constructor(api, toastyService, spinner, router, http, title, util) {
        this.api = api;
        ...
        this.api.get('users/get_admin').then((user) => {
