      ...
      _createClass(ManageWebsiteComponent, [{
            ...
            if (data && data.status === 200) {
              if (data && data.data && data.data.length) {
                ...
                if (function (x) {
                  ...
                  _this6.selectedItems = JSON.parse(info.web_category);
                  console.log(_this6.selectedItems);
        ...
        value: function getCategory() {
          ...
          this.api.get('categories').then(function (datas) {
            ...
            if (datas && datas.data && datas.data.length) {
              _this7.dropdownList = datas.data.filter(function (x) {
                return x.status === '1';
              });
        ...
        value: function submit() {
          ...
          if (this.haveSave) {
            ...
            this.spinner.show();
            this.api.post_private('settings/editList', param).then(function (data) {
              console.log('data', data);

              _this8.spinner.hide();

              if (data && data.status === 200) {
                _this8.success('status updated');

                _this8.haveSave = true;
              } else {
                _this8.spinner.hide();
            ...
            this.spinner.show();
            this.api.post_private('settings/save', _param).then(function (data) {
              console.log('data', data);
