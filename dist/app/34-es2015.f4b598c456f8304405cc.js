...
function View_DriverStatsComponent_5(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "h2", [["style", "text-align: center;"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, [" Sin Ordenes Encontradas\n"]))], null, null); }
...
class DriverStatsComponent {
    ...
    getStats() {
        ...
        if (this.did && this.from && this.to && this.statValue && this.statType) {
            ...
            this.api.post_private('orders/driverStats', param).then((data) => {
                this.apiCalled = true;
                this.spinner.hide();
                console.log(data);
                if (data && data.status === 200 && data.data.length) {
