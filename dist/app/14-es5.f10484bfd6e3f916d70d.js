    ...
    var ManageBannersComponent = /*#__PURE__*/function () {
      ...
      _createClass(ManageBannersComponent, [{
        ...
        value: function create() {
          ...
          if (!this.position || this.position === '' || !this.type || this.type === '' || !this.link || this.link === '' || !this.message || this.message === '') {
          ...
          this.spinner.show();
          this.api.post_private('banners/save', param).then(function (data) {
            _this5.spinner.hide();
        ...
        value: function update() {
          ...
          this.spinner.show();
          this.api.post_private('banners/editList', param).then(function (data) {
            _this6.spinner.hide();

            console.log(data);

            if (data && data.status && data.status === 200) {
              _this6.api.alerts(_this6.api.translate('Success'), _this6.api.translate('Updated!'), 'success');
